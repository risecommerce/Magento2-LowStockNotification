...
namespace Risecommerce\LowStockNotification\Helper;
...
/**
 * Class Data
 * @package Risecommerce\LowStockNotification\Helper
 */
class Data extends AbstractHelper
{
    ...
    const LOW_STOCK_SINGLE_ALERT_TEMPLATE_FILE =
                    'Risecommerce_LowStockNotification::notifications/low_stock_single_alert.phtml';

    const LOW_STOCK_ALERT_TEMPLATE_FILE = 'Risecommerce_LowStockNotification::notifications/low_stock_alert.phtml';
